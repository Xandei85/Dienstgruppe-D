// Hauptskript für den Schichtplan (v4.6.13 – Mobile Optimierung)
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Globaler Pointer-Up-Handler: beendet das Malen, wenn Touch/Maus/Stift losgelassen wird
  ...
  function renderGrid(namesArr, container, valueMap) {
    ...
    // Eventhandler für Zellen – Pointer-Events für Touch/Maus/Stift
    container.querySelectorAll('td.editable').forEach(cell => {
      // Einzeltipp zeichnet die Zelle
      cell.addEventListener('click', () => {
        handleCell(cell);
      });
      // Start des Malvorgangs
      cell.addEventListener('pointerdown', e => {
        // Verhindert, dass iOS versehentlich scrollt
        e.preventDefault();
        isPainting = true;
        handleCell(cell);
      });
      // Ziehen über Zellen malt fortlaufend
